...
class Validate
{
	public static function validateEmail($email){
		...
		//if (!filter_var($userEmail, FILTER_VALIDATE_EMAIL)) { // php >= 5.3
	...
	public static function validateUrl($url){
		$urlPattern = "#((http|https|ftp)://(\S*?\.\S*?))(\s|\;|\)|\]|\[|\{|\}|,|\"|'|:|\<|$|\.\s)#ie";
		//if (!filter_var($url, FILTER_VALIDATE_URL)) { // php >= 5.3
	...
	public static function stripTags($val, $allowedTags = ''){
		return strip_tags($val, $allowedTags);
	}

	public static function cleanNumber($val){
		return (int)$val;
	}

	public static function cleanStr($val){
		return self::cleanXss(self::stripTags(trim($val)));
	}
}